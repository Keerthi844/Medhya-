...
const Footer = () => {
  return (
    <footer className="bg-slate-700 border-t border-slate-800 pt-20 pb-8 mt-12">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-6 sm:gap-8 md:gap-10 lg:gap-12 mb-8 sm:mb-12 md:mb-16">
